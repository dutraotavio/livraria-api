...
import br.com.otavio.livraria.dto.Erro400Dto;
import br.com.otavio.livraria.dto.Erro500Dto;
...
public class TratamentoDeErros {
          ...
          public Erro500Dto tratarErro500(Exception ex, HttpServletRequest req) {
                    return new Erro500Dto(LocalDateTime.now(), ex.getClass().toString(), ex.getMessage(),
                                        req.getRequestURI());
          }
}
